...
#-----------------------------------------------------------------------
# Read the observations from ESSL
#-----------------------------------------------------------------------
...
# create test and train time periods

indices_test = [np.arange(0,11323)]  # from 1979 to 2009
print(indices_test.shape)
indices_train = [np.arange(11323,rgrESSLObs.shape[1])] # from 2010 to 2022
...
indices_test = [np.arange(0,int(1*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(1*rgrESSLObs.shape[1]/13)+1,int(2*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(2*rgrESSLObs.shape[1]/13)+1,int(3*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(3*rgrESSLObs.shape[1]/13)+1,int(4*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(4*rgrESSLObs.shape[1]/13)+1,int(5*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(5*rgrESSLObs.shape[1]/13)+1,int(6*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(6*rgrESSLObs.shape[1]/13)+1,int(7*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(7*rgrESSLObs.shape[1]/13)+1,int(8*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(8*rgrESSLObs.shape[1]/13)+1,int(9*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(9*rgrESSLObs.shape[1]/13)+1,int(10*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(10*rgrESSLObs.shape[1]/13)+1,int(11*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(11*rgrESSLObs.shape[1]/13)+1,int(12*rgrESSLObs.shape[1]/13)+1),
                np.arange(int(12*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1])
               ]
                
indices_train = [np.arange(int(1*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]),
                 np.concatenate((np.arange(0,int(1*rgrESSLObs.shape[1]/13)+1), np.arange(int(2*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(2*rgrESSLObs.shape[1]/13)+1), np.arange(int(3*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(3*rgrESSLObs.shape[1]/13)+1), np.arange(int(4*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(4*rgrESSLObs.shape[1]/13)+1), np.arange(int(5*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(5*rgrESSLObs.shape[1]/13)+1), np.arange(int(6*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(6*rgrESSLObs.shape[1]/13)+1), np.arange(int(7*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(7*rgrESSLObs.shape[1]/13)+1), np.arange(int(8*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(8*rgrESSLObs.shape[1]/13)+1), np.arange(int(9*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(9*rgrESSLObs.shape[1]/13)+1), np.arange(int(10*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(10*rgrESSLObs.shape[1]/13)+1), np.arange(int(11*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.concatenate((np.arange(0,int(11*rgrESSLObs.shape[1]/13)+1), np.arange(int(12*rgrESSLObs.shape[1]/13)+1,rgrESSLObs.shape[1]))),
                 np.arange(0,int(12*rgrESSLObs.shape[1]/13)+1)
                ]
...
for ii in range(len(indices_train)): 
    ...
    # Create Train data
    # ------------------------------------------------
    # I excluded all the data over water
    y_land_train = rgrESSLObs[0,indices_train[ii],:,:]
    # Create y_train
    ...
    selected_index_train0 = random.sample(index_train0.tolist(), int(len(index_train0)/70))
    ...
    # Create X_train 
    rgrERAVarall_EU = rgrERAVarall[:,:,ilaN:ilaS,indices]
    X_land_train = np.copy(rgrERAVarall_EU[indices_train[ii],:,:,:])
    ...
    # ------------------------------------------------
    # y_test
    y_land_test = np.copy(rgrESSLObs[0,indices_test[ii],:,:])
    y_test = y_land_test.reshape(y_land_test.shape[0]*y_land_test.shape[1]*y_land_test.shape[2])
    # X_test
    X_land_test = np.copy(rgrERAVarall_EU[indices_test[ii],:,:,:])
    ...
    print(f"EU Best Hyperparameters {ii}:", best)
    n = best['n_estimators']
    ...
    model.save_model(f'/glade/scratch/bblanc/ERA5_hail_model/xgboost_predictions/EU_XGBmodel_iteration{ii}.jason')
    
    # Make predictions on the test dataset
    preds_test = model.predict(xg_test_1)
    preds_test2 = np.copy(preds_test)
    
    np.save(f'/glade/scratch/bblanc/ERA5_hail_model/xgboost_predictions/Predictions_EU{ii}.npy', preds_test2)
